...
INTERNAL_ENV_VARS="${INTERNAL_ENV_VARS},LLM_PROVIDER=${LLM_PROVIDER:-${LLM_PROVIDER_DEFAULT}}"
INTERNAL_ENV_VARS="${INTERNAL_ENV_VARS},LLM_MODEL=${LLM_MODEL:-${LLM_MODEL_DEFAULT}}"

EXTERNAL_ENV_VARS="${EXTERNAL_ENV_VARS},LLM_PROVIDER=${LLM_PROVIDER:-${LLM_PROVIDER_DEFAULT}}"
EXTERNAL_ENV_VARS="${EXTERNAL_ENV_VARS},LLM_MODEL=${LLM_MODEL:-${LLM_MODEL_DEFAULT}}"
