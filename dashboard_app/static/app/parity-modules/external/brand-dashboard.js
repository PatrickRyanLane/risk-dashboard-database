...
function runInlineScript(scope) {
  ...
  async function loadRosterTickers(){
    try{
      ...
      rows.forEach(r=>{
        ...
        const favorite = isTrue(r.company_favorite || r['Company Favorite'] || r.favorite || r.Favorite);
        if (favorite) favoriteCompanies.add(company);
